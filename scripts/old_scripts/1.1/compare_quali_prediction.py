...
prediction = pd.read_csv("data/predictions/2026_Barcelona_quali_prediction_from_practice.csv")

quali_results = pd.read_csv("data/processed/2026_Barcelona_Q_results.csv")
